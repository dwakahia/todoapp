  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios.get('/get-posts').then(function (response) {
        _this.posts = response.data.slice(0, 5);
        Vue.$toast.success('Posts fetched successfully', {
          position: 'top-right'
        });
    ...
    updatePost: function updatePost() {
      ...
      if (this.validateForm()) {
        axios.post('/update-post', this.form).then(function (response) {
          _this3.posts = _this3.posts.map(function (post) {
            if (post.id === _this3.form.id) {
              return response.data;
            }

            return post;
          });
          Vue.$toast.success('Post updated successfully', {
            position: 'top-right'
          });
    ...
    deletePost: function deletePost(post) {
      ...
      axios.get("/delete-post/".concat(post.id)).then(function (response) {
        _this4.posts = _this4.posts.filter(function (response) {
          return response.id !== post.id;
        });
        Vue.$toast.success('Post deleted successfully', {
          position: 'top-right'
        });
      })["catch"](function (error) {
        Vue.$toast.error('something went wrong', {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-toast-notification/dist/theme-sugar.css":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-toast-notification/dist/theme-sugar.css ***!
  \****************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_theme_sugar_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./theme-sugar.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-toast-notification/dist/theme-sugar.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_theme_sugar_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_theme_sugar_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
  ...
  return _c("main", { staticClass: "sm:container sm:mx-auto sm:mt-10" }, [
    _c("div", { staticClass: "container my-12 mx-auto px-4 md:px-12" }, [
      _c(
        "form",
        {
          staticClass: "my-4 w-1/2 mx-auto",
          attrs: { action: "", method: "post" },
          on: {
            submit: function ($event) {
              $event.preventDefault()
              _vm.isEdit ? _vm.updatePost() : _vm.createPost()
            },
          },
        },
        [
          _c("div", { staticClass: "flex flex-wrap my-3" }, [
            _c(
              "label",
              {
                staticClass:
            ...
            _c("input", {
              ...
              class: [
                _vm.error.userId != null ? "border-red-500" : "border-blue-500",
              ],
              attrs: { id: "userid", type: "number", autofocus: "" },
          ...
          _c("div", { staticClass: "flex flex-wrap my-3" }, [
            ...
            _c("input", {
              ...
              staticClass: "form-input w-full",
              class: [
                _vm.error.title != null ? "border-red-500" : "border-blue-500",
              ],
          ...
          _c("div", { staticClass: "flex flex-wrap my-3" }, [
            ...
            _c("textarea", {
              ...
              staticClass: "form-input w-full",
              class: [
                _vm.error.body != null ? "border-red-500" : "border-blue-500",
              ],
              attrs: {
                name: "description",
                id: "description",
          ...
          _c("div", { staticClass: "flex" }, [
            _c(
              ...
              {
                staticClass:
                  "w-full  font-bold whitespace-no-wrap p-3 rounded-lg   no-underline text-gray-100 bg-red-500 hover:bg-red-700 sm:py-4 mr-3",
                attrs: { type: "submit" },
                on: {
            ...
            _c(
              ...
              {
                staticClass:
                  "w-full  font-bold whitespace-no-wrap p-3 rounded-lg   no-underline text-gray-100 bg-blue-500 hover:bg-blue-700 sm:py-4",
                attrs: { type: "submit" },
              },
              [
                _vm._v(
                  "\n                    " +
                    _vm._s(_vm.isEdit ? "Update Post" : "Add Post") +
                    "\n                "
                ),
              ]
            ),
      ...
      _c(
        ...
        _vm._l(_vm.posts, function (post, index) {
          return _c(
            ...
            {
              key: index,
              staticClass: "my-1 p-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3",
            },
            [
              _c(
                "div",
                {
                  staticClass:
                    "overflow-hidden rounded-lg shadow-lg flex flex-col h-full p-3",
                },
                [
                  _c("div", { staticClass: "flex justify-between" }, [
                    _c("span", { staticClass: "my-2 text-lg font-extrabold" }, [
                      _vm._v("PostId: " + _vm._s(post.id)),
                    ]),
                    _vm._v(" "),
                    _c("span", { staticClass: "my-2 text-lg font-extrabold" }, [
                      _vm._v("UserId: " + _vm._s(post.userId)),
                    ]),
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "my-1 font-extrabold" }, [
                    _vm._v("Title"),
                  ]),
                  _vm._v(" "),
                  _c("p", { staticClass: "my-1 text-base" }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "mb-2 flex-grow" }, [
                    _vm._v(
                      "\n                        " +
                        _vm._s(post.body) +
                        "\n                    "
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "flex items-center justify-between  my-1 md:p-4",
                    },
                    [
                      _c(
                        "button",
                        {
                          staticClass:
                            "bg-blue-500 p-3 rounded-md text-white font-medium mr-2",
                          on: {
                            click: function ($event) {
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "bg-red-700 p-3 rounded-md text-white font-medium",
                          on: {
                            click: function ($event) {
